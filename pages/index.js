...
import { faDatabase, faUserEdit, faCoffee, faClock } from "@fortawesome/free-solid-svg-icons";
...
const landing = () => {
  ...
  return (
    <React.Fragment>
      <div className="uk-position-relative uk-visible-toggle four" data-uk-slider="finite: true">
        <ul
              ...
              <div className="uk-position-center  text-left">
                <div className="width-70 margin-auto">
                  ...
                  <p className="text-gray-regular text-extra-large">
                    Finding a job or internship is messy, repetitive, and consumes a lot of time.
                    With Hirebee, save and filter all your jobs in one organized place, and finish
                    applying with a click of a button. Unlock a new level of time and peace.
                  </p>

                  <img className="margin-bottom-25px " src="images/separator.png" alt="" />
                  <div className="">
      ...
      ></a>
      {/* Services */}
      <div id="features" className="padding-top-bottom-100px bg-gray-transparent">
        <div className="container-2">
          <div className="row">
            <div className="col-md-8 col-sm-12 col-xs-12 center-col text-center margin-auto">
              <h2 className="text-weight-700 text-gray-dark">Check out the features.</h2>

              <p className="text-gray-regular text-center">
                With Beehired, rest assured that instead of spending hours on the application
                process, your instead honing your skills and increasing your value.
              </p>
            ...
            <div className="col-md-4 col-sm-12 col-xs-12 center-col text-left margin-auto md-text-center">
              <div className="sm-container-spread md-text-center">
                <div className="width-150 margin-left-auto margin-top-50px">
                  <Image src="/images/backgrounds/bg-02.png" alt="" width="350" height="780" />
                </div>
              </div>
            </div>
            <div className="col-md-4 col-sm-12 col-xs-12 center-col text-left margin-auto sm-margin-top-75px">
